...
export const actionsConfig: GameActionConfig[] = [
  {
    ...
    description:
      "Spend clout to create a viral meme campaign that boosts your support base online.",
    cost: { clout: 10 },
    perform: (state: GameState) => {
      ...
      return {
        ...
        message:
          "Your meme campaign goes viral, boosting support in several states!",
      };
    },
  },
  {
  ...
  },
  {
    ...
    name: "Organize Rally",
    description:
      "Spend funds to organize a rally in a target region to boost local support.",
    cost: { funds: 30 },
    perform: (state: GameState) => {
  ...
  },
  {
    ...
    description:
      "Secretly deploy a bot army to spread propaganda (high risk, high reward).",
    ...
    perform: (state: GameState) => {
      ...
      return {
        ...
        riskDelta: 15,
        message:
          "Bot army deployed nationwide, boosting influence everywhere (but greatly increasing exposure risk).",
      };
    },
  },
];
