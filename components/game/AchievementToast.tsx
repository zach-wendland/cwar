...
export const ACHIEVEMENTS = {
  FIRST_ACTION: {
    title: "First Move",
    description: "You made your first action!",
  },
  SUPPORT_25: {
    title: "Gaining Ground",
    description: "Reached 25% average support",
    type: "milestone" as ToastType,
  },
  SUPPORT_50: {
    title: "Rising Star",
    description: "Reached 50% average support",
    type: "milestone" as ToastType,
  },
  SUPPORT_75: {
    title: "Movement Leader",
    description: "Reached 75% average support",
    type: "milestone" as ToastType,
  },
  STREAK_3: {
    title: "On a Roll",
    description: "3 turns without increasing risk",
  },
  STREAK_5: {
    title: "Calculated",
    description: "5 turns without increasing risk",
  },
  STREAK_10: {
    title: "Master Strategist",
    description: "10 turns without increasing risk",
  },
  SURVIVED_HIGH_RISK: {
    title: "Narrow Escape",
    description: "Survived with risk above 80%",
    type: "warning" as ToastType,
  },
  CRITICAL_HIT: {
    title: "Lucky Strike!",
    description: "Your action had double effect!",
    type: "critical" as ToastType,
  },
};
